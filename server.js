...
import {checkIfIsUser, getToken} from './src/api/authentication';
import registerUserMenus from './src/authentication/signup';
...
app.post('/ussd', async (req, res) => {
    ...
    if (await checkIfIsUser(phone.substring(1))) {
        ...
        message = await registerUserMenus(textLength, text, phone);
    }
